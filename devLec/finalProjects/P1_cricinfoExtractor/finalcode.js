...
responseKaPromise.then(function (response) {
    ...
    let matchesKaJSON = JSON.stringify(matches);                    //jso -> json because we cannot print jso 
    fs.writeFileSync("matches.json", matchesKaJSON, "utf-8");       //created matches.json file to write all matches data 
